...
class DatabaseManager:
    def __init__(self, database_file='Info.db'):
        if os.name == 'nt':
            self.database_file = os.path.join(os.getenv('APPDATA'), 'HoyoHelper', 'data', 'database', database_file)
        else:
            self.database_file = os.path.join(os.getenv('HOME'), '.config', 'HoyoHelper', 'data', 'database', database_file)
        self.config_data = self.load_config()
        print(f"Configuration loaded from {self.database_file}.")
    ...
    def save_account(self, nickname: str, username: str, encrypted_password: str, games: List[str], webhook: str, cookie: str, passing: bool = False) -> bool:
        """
    ...
    def update_account(self, id: int, nickname: str, username: str, encrypted_password: str, games: List[str], webhook: str, cookie: str, passing: bool = False) -> bool: 
        """
    ...
    def save_group(self, name: str, members: List[str]) -> bool:
        """
    ...
    def remove_group_member(self, group_id: int, member: str) -> bool:
        """
    ...
    def add_group_member(self, group_id: int, member: str) -> bool:
        """
